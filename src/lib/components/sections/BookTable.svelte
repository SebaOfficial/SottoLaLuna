...
<section class="relative overflow-hidden py-32" id="prenota">
	<div class="relative z-10 mx-auto max-w-5xl px-6">
		<div class="rounded-3xl border border-primary/10 bg-white p-10 text-center shadow-2xl md:p-20">
			...
			<p class="mx-auto mb-12 max-w-xl text-lg text-charcoal/60">
				{locale.description}
			</p>
			...
			<div
				class="flex flex-col items-center justify-center gap-6 text-sm text-charcoal/40 md:flex-row"
			>
				...
				<div class="flex items-center gap-2">
					...
					<a class="text-charcoal/70" href="mailto:{locale.email}">{locale.email}</a>
				</div>
			</div>
		</div>
	</div>
