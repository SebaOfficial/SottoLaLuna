...
| [about.jpg](./src/lib/assets/about.jpg) | [src/lib/assets/](./src/lib/assets/)          | L'immagine che viene mostrata nella sezione "Chi siamo".                      |
| [0.jpg](./src/lib/assets/menu/0.jpg)    | [src/lib/assets/menu](./src/lib/assets/menu/) | L'immagine che rappresenta il primo piatto mostrato nella sezione del Menù.   |
| [1.jpg](./src/lib/assets/menu/1.jpg)    | [src/lib/assets/menu](./src/lib/assets/menu/) | L'immagine che rappresenta il secondo piatto mostrato nella sezione del Menù. |
| [2.jpg](./src/lib/assets/menu/2.jpg)    | [src/lib/assets/menu](./src/lib/assets/menu/) | L'immagine che rappresenta il terzo piatto mostrato nella sezione del Menù.   |
| [3.jpg](./src/lib/assets/menu/3.jpg)    | [src/lib/assets/menu](./src/lib/assets/menu/) | L'immagine che rappresenta il quarto piatto mostrato nella sezione del Menù.  |
...
Questo sito è stato sviluppato da [Sebastiano Racca](https://racca.me) per conto del ristorante "Sotto La Luna".
